...
export default function MapSection() {
  ...
  return (
    <section ref={sectionRef} id="map" className="py-20 relative overflow-hidden">
      <div className="max-w-[1100px] mx-auto px-4">
        ...
        <div className={`relative transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ transitionDelay: "200ms" }}>
          ...
          <div className="relative bg-card border border-border rounded-2xl overflow-hidden shadow-2xl">
            ...
            {/* Floating Info Card */}
            <div className="absolute bottom-6 left-6 right-6 md:right-auto md:w-80 bg-card/95 backdrop-blur-lg border border-border rounded-xl p-5 shadow-xl">
